...
taskform.addEventListener("submit", function(event) {
    ...
    if (task) addTask(task, dueDate, estimatedTime, priorityRating, false, subjectName);
    taskModal.classList.remove('show');
});
...
function renderTask(task1) {
    ...
    subject.textContent = task1.subjectName;
    subject.setAttribute('contenteditable', 'true');
    let taskTitle = document.createElement('h2');
    taskTitle.textContent = task1.taskDescription;
